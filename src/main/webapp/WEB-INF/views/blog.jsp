        ...
        <div class="col-md-12">
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    ...
                    <form:form action="./confirmpage" commandName="blo" role="form" class="lead" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <form:input type="text" path="blogname" placeholder="blogname" class="form-control input-md"/>
                                    </div>
                                     <div class="form-group">
                                       
                                       <form:input type="text" path="blogTitle" placeholder="blogTitle"  class="form-control input-md"/>
                                    </div>
                                    
                                    <div class="form-group">
                                        
                                        <form:input cols="48" path="blogContent" placeholder="blogContent"  class="form-control input-md" rows="8"/>
                                    </div>
                                     <div class="form-group">
                                       
                                      <form:input type="text" path="blogtag" placeholder="blogtag"  class="form-control input-md"/>
                                    </div>
                                </div>
                            </div>
